...
@interface BSLLoginTableViewController ()

@end

@implementation BSLLoginTableViewController
...
- (IBAction)loginPressed:(id)sender {
    ...
    ///get contents of username field
    ...
    [PFUser logInWithUsernameInBackground:username password:password block:^(PFUser *user, NSError *error) {
        ...
        if (error) {
            ...
            // we are invoking the method on the delegate to dismiss "self" - the login screen
